...
@click.option("--attn_type", default=None, type=str)
...
def main(
    ...
    ###### Choose attention
    net_kwargs['attn_type'] = attn_type
    net_kwargs['decoder']['attn_type'] = attn_type
    net_kwargs['alpha'] = alpha
    net_kwargs['decoder']['alpha'] = alpha
    ...
    if resume and checkpoint_path.exists():
        ...
        variant["algorithm_kwargs"]["start_epoch"] = checkpoint["epoch"] 
    else:
    ...
    if eval:
        ...
        print(f"Stats [EVAL]:", eval_logger, flush=True)
        print("")
        val_stats = {
